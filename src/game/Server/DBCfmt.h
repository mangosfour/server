...
const char BattlemasterListEntryfmt[]="niiiiiiiiiiiiiiiisxiiiiiiiiixx";   // TODO: NEED TO CONFIRM THIS
...
const char SpellScalingEntryfmt[]="niiiifffi";   // TODO: NEED TO CONFIRM THIS
